(function () {
    ...
    var menuData = [
        ...
        { 'name': '黄豆蚝豉排骨苦瓜汤', 'data': [{ 'value': 80, 'name': '蚝豉' }, { 'value': 100, 'name': '黄豆' }, { 'value': 200, 'name': '苦瓜' }, { 'value': 500, 'name': '排骨' }] },
        ...
        { 'name': '眉豆花生红枣猪尾汤', 'data': [{ 'value': 150, 'name': '眉豆' }, { 'value': 50, 'name': '花生' }, { 'value': 30, 'name': '红枣' }, { 'value': 750, 'name': '猪尾' }, { 'value': 30, 'name': '姜' }, { 'value': 2, 'name': '陈皮' }] },
    ...
    //         var foundMenu = menuData.find(function (menu) {
    //             return menu.name === userInput;
    //         });
    //
    //         if (foundMenu) {
    //             updateChart(foundMenu);
    //         } else {
    //             alert('未找到对应菜品数据');
    //         }
    //     });
    ...
    updateChart({ 'name': '淮山党参鹌鹑汤', 'data': [{ 'value': 15, 'name': '党参' }, { 'value': 15, 'name': '淮山' }, { 'value': 200, 'name': '鹌鹑' }, { 'value': 250, 'name': '瘦肉' }, { 'value': 30, 'name': '姜' }] },
    )
    // 更新图表函数
    function updateChart(menu) {
        var option = {
            //背景颜色线性渐变b
            ...
            legend: {  // 添加图例配置
                ...
                data: menu.data.map(function (item) {
                    return item.name;
                })
            },
            series: [{
            ...
            graphic: [
                {
                    ...
                    top: 'center',
                    onclick: function () {
                        window.location.href = '药膳搜索.html?YSname=' + menu.name;
            ...
            tooltip: {
                formatter: function (params) {
                    return params.data.name + '<br>' + '重量 ' + params.data.value + 'g';
                }
            },
        };
